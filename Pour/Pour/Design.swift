...
struct Design {
    ...
    static let tiltFactor: CGFloat = 1.5
    static let rimHeight: CGFloat = 0.2
    static let tickwidth: CGFloat = 0.3

    static let contentsTextsizeFactor: CGFloat = 2.0
    static let capacityTextsizeFactor: CGFloat = 1.0
