...
func canPour(_ capacities: CapacitiesConfig, _ contents: ContentsConfig, _ pouring: Pouring) -> Bool
{
...
func pourableQuantity(_ capacities: CapacitiesConfig, _ contents: ContentsConfig, _ pouring: Pouring) -> Int
{
...
func performPouring(_ capacities: CapacitiesConfig, _ contents: ContentsConfig, _ pouring: Pouring) -> ContentsConfig
{
...
func solve(_ capacities: CapacitiesConfig, _ contents: ContentsConfig,  _ target: Int) -> [Pouring]?
{
